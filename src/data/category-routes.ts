...
export const CATEGORY_ROUTES: CategoryRoute[] = [
  // Diaries
  { path: "/diaries", categoryId: 18, title: "Diaries" },
  { path: "/diaries/pocket", categoryId: 39, title: "Pocket Diaries", filterConfig: { disableSize: true } },
  { path: "/diaries/a5", categoryId: 40, title: "A5 Diaries", filterConfig: { disableSize: true } },
  { path: "/diaries/quarto", categoryId: 41, title: "Quarto Diaries", filterConfig: { disableSize: true } },
  { path: "/diaries/a4", categoryId: 42, title: "A4 Diaries", filterConfig: { disableSize: true } },
  { path: "/diaries/real-leather", categoryId: 43, title: "Real Leather Diaries", filterConfig: { disableSize: true } },
  { path: "/diaries/faux-leather", categoryId: 44, title: "Faux Leather Diaries", filterConfig: { disableSize: true } },
  { path: "/diaries/all", categoryId: 18, title: "All Diaries" },

  // Notebooks
  { path: "/notebooks", categoryId: 17, title: "Notebooks" },
  { path: "/notebooks/a5", categoryId: 19, title: "A5 Notebooks", filterConfig: { disableLayout: true, disableSize: true } },
  { path: "/notebooks/a6", categoryId: 45, title: "A6 Notebooks", filterConfig: { disableLayout: true, disableSize: true } },
  { path: "/notebooks/real-leather", categoryId: 47, title: "Real Leather Notebooks", filterConfig: { disableLayout: true, disableSize: true } },
  { path: "/notebooks/faux-leather", categoryId: 48, title: "Faux Leather Notebooks", filterConfig: { disableLayout: true, disableSize: true } },
  { path: "/notebooks/eco-friendly", categoryId: 46, title: "Eco Friendly Notebooks", filterConfig: { disableLayout: true, disableSize: true } },
  { path: "/notebooks/all", categoryId: 17, title: "All Notebooks" },
