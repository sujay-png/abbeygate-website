  ...
  sections: [
    {
      ...
      content: `
        <p class="mb-4 text-[#1F2124] text-[15px] font-work leading-7">
        ...
        <p class="mb-8 text-[#1F2124] text-[15px] font-work leading-7">
    ...
    },
    {
      ...
      content: `
        ...
        <div class="space-y-6">
          <p class="text-[#1F2124] text-[15px] font-work leading-7">
            <span class="font-bold text-[#1F2124]">Gutter :</span> <span >The gutter refers to the inner margin of a book, the space between the two facing pages. It’s essential for ensuring that text doesn’t get lost in the binding. When designing a layout, it’s important to account for the gutter to maintain readability.</span>
          </p>
          <p class="text-[#1F2124] text-[15px] font-work leading-7">
            <span class="font-bold text-[#1F2124]">Spine :</span> <span >The spine is the edge of the book where the pages are bound together. It is often where the book title, author name, and publisher logo are placed. The spine’s thickness can vary depending on the book’s page count and type of binding.</span>
          </p>
          <p class="text-[#1F2124] text-[15px] font-work leading-7">
            <span class="font-bold text-[#1F2124]">Signature :</span> <span >A signature is a group of pages that are printed on a single sheet of paper and then folded together. Multiple signatures are stacked and bound to form a book. This term is commonly used in the context of traditional bookbinding processes.</span>
          </p>
          <p class="text-[#1F2124] text-[15px] font-work leading-7">
            <span class="font-bold text-[#1F2124]">Trim Size :</span> <span >The trim size refers to the final dimensions of a book after it has been printed and trimmed. It determines the width and height of the finished book, which is typically set before printing begins.</span>
          </p>
          <p class="text-[#1F2124] text-[15px] font-work leading-7">
            <span class="font-bold text-[#1F2124]">Bleed :</span> <span >Bleed is the area of the page that extends beyond the trim line, ensuring that there are no white borders after cutting. It is particularly important for images or backgrounds that reach the edges of the page.</span>
          </p>
          <p class="text-[#1F2124] text-[15px] font-work leading-7">
            <span class="font-bold text-[#1F2124]">Cover Stock :</span> <span >Cover stock refers to the type of paper used for the book’s cover. It’s usually thicker and more durable than the paper used for the interior pages, offering both protection and aesthetic appeal.</span>
          </p>
          <p class="text-[#1F2124] text-[15px] font-work leading-7">
            <span class="font-bold text-[#1F2124]">Typeface :</span> <span >A typeface is a particular design of type, which includes various fonts, sizes, and styles. The choice of typeface can significantly affect the readability and overall design of a book.</span>
          </p>
        </div>
      `
    },
    {
      ...
      content: `
        <p class="mb-6 text-[#1F2124] text-[15px] font-work leading-7">
        ...
        <h3 class="text-[22px] md:text-2xl font-bold text-black font-sans tracking-tight mb-8">Other Binding Types</h3>
      `,
      cards: [
        {
      ...
      subcontent: `
        <p class="mt-8 text-[#1F2124] text-[15px] font-work leading-7">
    ...
    },
    {
      ...
      subcontent: `
        <h4 class="mt-8 mb-4 font-bold text-black text-xl font-sans tracking-tight">Considerations for Layout Design</h4>
        <p class="text-[#1F2124] text-[15px] font-work leading-7">
